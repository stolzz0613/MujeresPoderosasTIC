            ...
            <div className={whoWeAre.containerWho}>
                ...
                <div className={whoWeAre.container_text}>
                    ...
                    <div className={whoWeAre.secondary_title}>
                        <img src ='https://i.imgur.com/Spm9qlp.jpg'/>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#E9E0FF" fillOpacity="1" d="M0,192L80,181.3C160,171,320,149,480,160C640,171,800,213,960,208C1120,203,1280,149,1360,122.7L1440,96L1440,320L1360,320C1280,320,1120,320,960,320C800,320,640,320,480,320C320,320,160,320,80,320L0,320Z"></path></svg>
                        <h2>¡Una comunidad de mujeres con poder de trasformar su vida!</h2>
                    </div>
                </div>
            </div>
